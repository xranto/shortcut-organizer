					...
					<div class="relative transform overflow-hidden rounded-lg bg-white px-4 pb-4 pt-5 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg sm:p-6">
						<div class="sm:flex sm:items-start">
							...
							<div class="mt-3 flex-1 text-center sm:ml-4 sm:mt-0 sm:text-left">
								<h3 class="text-base font-semibold leading-6 text-gray-900" id="modal-title">{{ t('dlgtitleAddShortcut') }}</h3>
								<div class="mt-2">
									<div>
										<label for="new_shortcut_label" class="block text-sm font-medium leading-6 text-gray-900">{{ t('labelTitle') }}</label>
										<div class="mt-2">
								...
								<div class="mt-2">
									<div>
										<label for="new_shortcut_url" class="block text-sm font-medium leading-6 text-gray-900">{{ t('labelUrl') }} *</label>
										<div class="mt-2">
						...
						<div class="mt-5 sm:ml-10 sm:mt-4 sm:flex sm:pl-4">
							...
							<button v-on:click="hide_shortcut_dlg" type="button" class="mt-3 inline-flex w-full justify-center rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50 sm:ml-3 sm:mt-0 sm:w-auto">{{ t('buttonCancel') }}</button>
						</div>
					</div>
				</form>
